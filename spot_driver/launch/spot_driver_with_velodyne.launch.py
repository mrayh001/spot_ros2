...
def launch_setup(context: LaunchContext, ld: LaunchDescription) -> None:
    ...
    # Hardcode the values for the LiDAR's position and orientation
    x_value = '-0.247'
    y_value = '0'
    z_value = '0.2032'
    roll_value = '0'
    ...
    # Use the hardcoded values as arguments for the static_transform_publisher
    velodyne_to_base_link_tf = launch_ros.actions.Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='base_to_velodyne_broadcaster',
        arguments=[
            '--x', x_value, 
            '--y', y_value, 
            '--z', z_value, 
    ...
    ld.add_action(velodyne_to_base_link_tf)
